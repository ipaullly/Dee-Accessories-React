# Dee Accessories React UI

this app demostrates the basic functionality for an ecommerce site that allows user authentication, cart functionality, stripe e-payments and an admin dashboard.
